...
int main()
{
    ...
    timming_byte++;
    pkt->subcommand = GetRegulatedVoltage;
    ...
    struct GetRegulatedVoltageReply *voltage_range = (struct GetRegulatedVoltageReply *)reply->data;
    fprintf(stderr, "Rnage: 0x%04X\n", (voltage_range->high << 8) | voltage_range->low);
